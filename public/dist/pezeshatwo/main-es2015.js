...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/fesm2015/angular-fire.js");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/fesm2015/angular-fire-firestore.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_11__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].firebase, 'pezesha-form'),
...
let HomeComponent = class HomeComponent {
    ...
    constructor(homeService, flashMessage, router) {
...
let HomeService = class HomeService {
    constructor(afs) {
        this.afs = afs;
        this.formsCollection = this.afs.collection('forms', ref => ref.orderBy('lastName', 'asc'));
    }
    getForms() {
        this.forms = this.formsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => {
...
module.exports = __webpack_require__(/*! /home/corebra/Desktop/exp/peztwo/src/main.ts */"./src/main.ts");
